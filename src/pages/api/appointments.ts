...
function toManilaTimestamptz(datetimeLocal: string): string | null {
  // Accept:
  // - "YYYY-MM-DDTHH:MM" (from <input type="datetime-local">) -> interpret as Asia/Manila (+08:00)
  // - ISO strings with timezone -> pass through
...
function redirectToBooking(status: 'success' | 'error') {
