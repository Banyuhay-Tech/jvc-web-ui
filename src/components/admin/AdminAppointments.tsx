...
export default function AdminAppointments() {
      ...
      <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md">
          <div className="text-center mb-8">
            <div className="w-14 h-14 bg-[#0a441e] rounded-full flex items-center justify-center mx-auto mb-4">
              <span className="text-white font-black text-xl">JVC</span>
            </div>
            <h1 className="text-2xl font-bold text-[#0a441e]">Admin Access</h1>
  ...
  return (
    <div className="min-h-screen bg-slate-100">
      <header className="bg-[#0a441e] text-white py-4 px-6">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-bold">JVC Admin</h1>
