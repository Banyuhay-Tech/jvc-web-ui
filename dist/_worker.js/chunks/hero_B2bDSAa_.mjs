...
import { c as createComponent, m as maybeRenderHead, a as renderTemplate } from './astro/server_CUdWvnOA.mjs';
/* empty css                        */

const HERO_CONTENT = {
  title: "Jamir Veterinary Clinic",
  subtitle: "Compassionate Care for Pets and\nPeace of Mind for Pet Owners",
...
const $$Hero = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section class="hero-section" data-astro-cid-kqoyo4w6> <div class="hero-container" data-astro-cid-kqoyo4w6> <div class="content-wrapper" data-astro-cid-kqoyo4w6> <div class="text-column" data-astro-cid-kqoyo4w6> <h1 class="hero-title" data-astro-cid-kqoyo4w6>${HERO_CONTENT.title}</h1> <h2 class="hero-subtitle" data-astro-cid-kqoyo4w6>${HERO_CONTENT.subtitle}</h2> <p class="hero-description" data-astro-cid-kqoyo4w6>${HERO_CONTENT.description}</p> </div> </div> </div> </section> `;
