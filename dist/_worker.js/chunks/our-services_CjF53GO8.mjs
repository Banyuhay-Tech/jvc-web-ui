...
import { c as createComponent, m as maybeRenderHead, b as addAttribute, r as renderComponent, a as renderTemplate, e as renderScript } from './astro/server_D6c3p7-M.mjs';
  ...
  branches: [
    {
      ...
      services: [
        ...
        { title: "Laboratory Tests", iconName: "laboratory" }
      ]
    },
    {
      name: "IMUS BRANCH",
      ...
      services: [
        { title: "Veterinary Consultation", iconName: "consultation" },
        { title: "Confinement", iconName: "confinement" },
        { title: "Surgery", iconName: "surgery" },
        { title: "Vaccination", iconName: "vaccination" },
        { title: "Laboratory Tests", iconName: "laboratory" },
        { title: "Microscopy", iconName: "microscopy" },
        { title: "Ultrasonography", iconName: "ultrasonography" },
        { title: "Pharmacy", iconName: "pharmacy" }
      ]
    }
  ]
...
function ServiceCardIcon({ name, className, size = 64 }) {
  const Icon = iconMap[name] ?? Stethoscope;
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className, size, strokeWidth: 1.5, "aria-hidden": true });
}
...
const $$url = "/home/sections/our-services";
...
export { $$OurServices as $, _page as _ };
